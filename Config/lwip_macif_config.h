...
#define CONF_LWIP_MACIF_FLAG                                            \
	((CONF_LWIP_MACIF_BROADCAST ? NETIF_FLAG_BROADCAST : 0)             \
	 | (CONF_LWIP_MACIF_ETHARP ? NETIF_FLAG_ETHARP : 0)                 \
	 | (CONF_LWIP_MACIF_IGMP ? NETIF_FLAG_IGMP : 0) | NETIF_FLAG_ETHERNET | NETIF_FLAG_MLD6)
#endif
...
#define CONF_LWIP_MACIF_HOSTNAME "eth0"
#endif
...
#define CONF_LWIP_MACIF_HOSTNAME_ABBR "e0"
#endif
...
#define CONF_LWIP_MACIF_STATIC_IP 0
#endif
...
#define CONF_LWIP_MACIF_IP "192.168.1.103"
#endif
...
//#define CONF_AT24MAC_ADDRESS 0x5f
//#endif
